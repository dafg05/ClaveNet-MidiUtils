...
def test1():
    ...
    dataAug.augmentationScheme(SOURCE_DIR, OUTPUT_DIR, EXAMPLES_TEST_DIR, styleParams, numTranformations = 2, fixedPartsToReplace = FIXED_PARTS_TO_REPLACE)
    print("test1 done")
...
def test3():
    ...
    dataAug.augmentationScheme(SOURCE_DIR, OUTPUT_DIR, EXAMPLES_TEST_DIR, styleParams, numTranformations = 2, numReplacements=2)
